# Viral Post Research Tool — Project Context for Codex

> When you scaffold the standalone project, copy this file to the new repo root as `AGENTS.md`.
...
profiles, a stored `trends`/`trend_posts` table, a Codex trend-clustering job, cron / scheduling,
